...
{
    /// <summary>
    /// TOP API: taobao.oc.eservice.appoint.save
    /// </summary>
    public class OcEserviceAppointSaveRequest : BaseTopRequest<Top.Api.Response.OcEserviceAppointSaveResponse>
    {
        /// <summary>
        /// 预约信息结构
        /// </summary>
        public string ParamO2oAppointInfoDTO { get; set; }

        public O2oAppointInfoDtoDomain ParamO2oAppointInfoDTO_ { set { this.ParamO2oAppointInfoDTO = TopUtils.ObjectToJson(value); } } 
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("param_o2o_appoint_info_d_t_o", this.ParamO2oAppointInfoDTO);
        ...
        {
            RequestValidator.ValidateRequired("param_o2o_appoint_info_d_t_o", this.ParamO2oAppointInfoDTO);
        }
...
public class O2oAppointInfoDtoDomain : TopObject
{
	        ...
	        public Nullable<long> AppointCode { get; set; }
